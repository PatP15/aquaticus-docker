...
RUN svn co https://oceanai.mit.edu/svn/moos-ivp-aquaticus-oai/trunk/ moos-ivp-aquaticus
...
RUN sudo chown -R moos:moos moos-ivp-rlagent pyquaticus moos-ivp scripts requirements.txt mdo-hurt-s pyquaticus_submission
