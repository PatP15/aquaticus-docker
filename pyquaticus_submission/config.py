...
class JervisBayConfig:
    ...
    def __init__(self):
        ...
        self.red_zone_ul = [zone2[1][0],  zone2[1][1]]
        self.red_zone_ur = [zone2[2][0], zone2[2][1]]
        self.red_zone_ll = [zone2[0][0], zone2[0][1]]
        self.red_zone_lr = [zone2[3][0], zone2[3][1]]

        self.blue_zone_ul = [zone1[1][0],  zone1[1][1]]
        self.blue_zone_ur = [zone1[2][0],  zone1[2][1]]
